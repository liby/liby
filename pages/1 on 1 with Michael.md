  ...
  collapsed:: true
	...
	- **/ɪ/ 和 /iː/**
		...
		- **Minimal Pairs Examples for /ɪ/ and /iː/**
			...
			- ship /ʃɪp/ - sheep /ʃiːp/
- 2023-11-12
	- 动名词（gerund）和不定词（infinitive）的用法与区别
		- 动名词（Gerund）
		  collapsed:: true
		...
		- 不定词（Infinitive）
		  collapsed:: true
			...
			- **用法**：
				...
				- **主语补足语**：无限动词可以作为主语补足语，说明主语的具体内容。
					- 例如：“Her dream is to become a singer.”（她的梦想是成为一名歌手。）
				- **形容词补足语**：无限动词可以用作形容词补足语，修饰名词或代词。
					- 例如：“I have a lot to do.”（我有很多事情要做。）
				- **介词 “to” 后**：有时 “to” 作为介词使用时，后面接无限动词。
					- 例如：“She is the first to arrive.”（她是第一个到达的。）
		- 动名词与不定词的区别
			- **作用不同**：动名词强调的是动作本身，作为名词使用；无限动词强调的是动作的可能性或目的，作为动词或名词使用。
			- **用法不同**：动名词多用于需要名词的句子位置，如主语、宾语；无限动词则用于表示目的、意图或某些特定动词后的宾语。
			- **固定搭配**：有些动词后面固定要用动名词，如 “enjoy”、“avoid”；而有些动词后面固定要用无限动词，如 “decide”、“hope”。
			- **介词后**：介词后面通常跟动名词，而不是无限动词。